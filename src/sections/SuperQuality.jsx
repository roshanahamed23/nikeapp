...
const SuperQuality = () => {
  return (
    ...
    className='flex max-lg:flex-col w-full justify-between gap-10 items-center max-container'
    >
      <div className='flex flex-1 flex-col'>
        ...
        <p className='mt-2 info-text lg:max-w-lg'>Our dedication to detail and excellence ensures your satisfaction</p>
        <div className='mt-11 '>
